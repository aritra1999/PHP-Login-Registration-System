...
<div class="container">
			...
			<form role="form" method="post" action="" autocomplete="off">
				...
				<p>Not A member? 	<a href='./'>Back to home page</a></p>
				<hr>
				...
				<hr>
					...
					<!-- <div class="col-xs-6 col-md-6"><input type="submit" name="submit" value="Login" class="btn btn-primary btn-block " tabindex="5"></div> -->
